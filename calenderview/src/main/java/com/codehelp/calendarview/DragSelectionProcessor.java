...
public class DragSelectionProcessor implements DragSelectTouchListener.OnAdvancedDragSelectListener {
     ...
     */
    DragSelectionProcessor(ISelectionHandler selectionHandler)
    {
        mMode = Mode.Simple;
     ...
     * @return this
     */
    DragSelectionProcessor withMode(Mode mode)
    {
        mMode = mode;
        return this;
    }
     ...
     * @return this
     */
    private DragSelectionProcessor withCheckSelectionState(boolean check)
    {
